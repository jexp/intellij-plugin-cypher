...
import com.neueda4j.intellij.plugin.cypher.psi.impl.*;
...
public interface CypherTypes {
  ...
  IElementType L_FUNCTION = new CypherTokenType("l_function");
  ...
  IElementType OP_ENDRELPATTERN = new CypherTokenType("]-()");
  IElementType OP_ENDRELPATTERNDIRECTED = new CypherTokenType("]->()");
  ...
  IElementType OP_STARTRELPATTERN = new CypherTokenType("()-[");
  IElementType OP_STARTRELPATTERNDIRECTED = new CypherTokenType("()<-[");
