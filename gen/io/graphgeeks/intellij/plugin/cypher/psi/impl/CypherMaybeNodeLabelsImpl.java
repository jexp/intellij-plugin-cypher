...
public class CypherMaybeNodeLabelsImpl extends ASTWrapperPsiElement implements CypherMaybeNodeLabels {

  public CypherMaybeNodeLabelsImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CypherVisitor) ((CypherVisitor)visitor).visitMaybeNodeLabels(this);
