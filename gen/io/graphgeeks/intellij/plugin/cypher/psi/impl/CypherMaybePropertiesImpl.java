...
public class CypherMaybePropertiesImpl extends ASTWrapperPsiElement implements CypherMaybeProperties {

  public CypherMaybePropertiesImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof CypherVisitor) ((CypherVisitor)visitor).visitMaybeProperties(this);
